...
INSTALLED_APPS = [
    ...
    # Project apps (make sure you create these apps with `startapp`)
    "core",
    "machines",
    "logs",
    "alerts",
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "siem_lite"),
...
# Optional: extra project-level static directory (besides app/static/)
# You can keep this empty or add BASE_DIR / "static" if you want a global static/ folder.
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
